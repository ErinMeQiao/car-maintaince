...
$(document).ready(function(){
			...
			$("#payoutCdescription").formValidator({empty:false,onshow:" ",onfocus:"请输入1-80个字符",oncorrect:"校验通过"}).inputValidator({min:1,onerror:"支出说明不能为空"}).inputValidator({min:1,max:80,onerror:"支出说明长度不正确"});
