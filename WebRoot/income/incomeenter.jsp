...
<html>
	...
	<script src='<c:url value="/scripts/income/incomeenter.js"/>'></script>
	<script type="text/javascript">
		function formsubmit(){
			$("#incomeenterForm").submit();
		}
	</script>
	</head>
	...
	<div id="mainbody">
	  <div id="view">
	    <h1><span class="viewinfo">家庭收入  > 收入录入</span></h1>
	  </div>
	  <form action="${contextvar}/incomeenter.action" method="post" id="incomeenterForm" name="incomeenterForm">
	    <div id="userInfo" class="door">
		  ...
		  <input type="hidden" id="approvestatus" name="incomeInfo.approvestatus" value="0"/>
	  	  <ul>
		  ...
		  <ul>
			...
			<li class="userInfoR">
			  <textarea id="incomeCdescription" name="incomeInfo.idescription" cols="20" rows="2">${incomeInfo.idescription}</textarea>&nbsp;<span class="redstar">*</span>
			</li>
			<li class="userInfoR">
