...
<html>
	...
	<script src='<c:url value="/scripts/debitcredit/debitcreditupdate.js"/>'></script>
	...
	<div id="mainbody">
	  <div id="view">
	    <h1><span class="viewinfo">家庭借贷 > 借贷管理 > 借贷信息修改</span></h1>
	  </div>
	  <form action="${contextvar}/debitcreditupdate.action" method="post" id="debitcreditupdateForm" name="debitcreditupdateForm">
	    <div id="userInfo" class="door">
		  ...
		  <input type="hidden" id="approvestatus" name="debitcreditInfo.approvestatus" value="${debitcreditInfo.approvestatus}"/>
		  <input type="hidden" id="dbid" name="debitcreditInfo.dbid" value="${debitcreditInfo.dbid}"/>
		  <input type="hidden" id="restatusapp" name="debitcreditInfo.restatusapp" value="${debitcreditInfo.restatusapp}"/>
		  <input type="hidden" id="enterdate" name="debitcreditInfo.enterdate" value="${debitcreditInfo.enterdate}"/>
		  <input type="hidden" id="enteruser" name="debitcreditInfo.enteruser" value="${debitcreditInfo.enteruser}"/>
	  	  <ul>
		  ...
		  <ul>
			...
			<li class="userInfoR">
				<select name="debitcreditInfo.cdflag" id="debitcreditInfocdflagTip" style="width: 155px">
			...
			<li class="userInfoR"><div id="debitcreditInfocdflagTipTip" style="width: 250px"></div></li>
		  </ul>
	  	  <ul>
			<li class="userInfol">偿还标志：</li>
			<li class="userInfoR">
				<select name="debitcreditInfo.repayflag" id="repayflag" style="width: 155px">
					<option value="">请选择</option>
					<option value="1" <c:if test="${debitcreditInfo.repayflag eq 1}">selected</c:if>>已偿还</option>
					<option value="0" <c:if test="${debitcreditInfo.repayflag eq 0}">selected</c:if>>未偿还</option>
				</select>&nbsp;<span class="redstar">*</span>
			</li>
			<li class="userInfoR"><div id="repayflagTip" style="width: 250px"></div></li>
		  </ul>	 	 
		  <ul>
