...
<html>
	...
	<script src='<c:url value="/scripts/finance/financeupdate.js"/>'></script>
	<script type="text/javascript">
		function formsubmit(){
			$("#financeupdateForm").submit();
		}
	</script>
	</head>
	...
	<div id="mainbody">
	  <div id="view">
	    <h1><span class="viewinfo">家庭理财 > 理财管理 > 理财信息修改</span></h1>
	  </div>
	  <form action="${contextvar}/financeupdate.action" method="post" id="financeupdateForm" name="financeupdateForm">
	    <div id="userInfo" class="door">
		  ...
		  <input type="hidden" id="approvestatus" name="financeInfo.approvestatus" value="${financeInfo.approvestatus}"/>
		  <input type="hidden" id="fid" name="financeInfo.fid" value="${financeInfo.fid}"/>
		  <input type="hidden" id="enterdate" name="financeInfo.enterdate" value="${financeInfo.enterdate}"/>
		  <input type="hidden" id="enteruser" name="financeInfo.enteruser" value="${financeInfo.enteruser}"/>
		  <input type="hidden" id="ohandstatus" name="financeInfo.ohandstatus" value="${financeInfo.ohandstatus}"/>
		  <input type="hidden" id="appohand" name="financeInfo.appohand" value="${financeInfo.appohand}"/>
	  	  <ul>
		  ...
		  <ul>
			...
			<li class="userInfoR">
			  <textarea id="financeFdescription" name="financeInfo.fdescription" cols="20" rows="2">${financeInfo.fdescription}</textarea>
			</li>
			<li class="userInfoR">
