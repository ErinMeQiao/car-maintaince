...
<html>
	...
	<script src='<c:url value="/scripts/payout/payoutenter.js"/>'></script>
	<script type="text/javascript">
		function formsubmit(){
			$("#payoutenterForm").submit();
		}
	</script>
	</head>
	...
	<div id="mainbody">
	  <div id="view">
	    <h1><span class="viewinfo">家庭支出  > 支出录入</span></h1>
	  </div>
	  <form action="${contextvar}/payoutenter.action" method="post" id="payoutenterForm" name="payoutenterForm">
	    <div id="userInfo" class="door">
		  ...
		  <input type="hidden" id="approvestatus" name="payoutInfo.approvestatus" value="0"/>
	  	  <ul>
		  ...
		  <ul>
			...
			<li class="userInfoR">
			  <textarea id="payoutCdescription" name="payoutInfo.pdescription" cols="20" rows="2">${payoutInfo.pdescription}</textarea>&nbsp;<span class="redstar">*</span>
			</li>
			<li class="userInfoR">
			  <div id="payoutCdescriptionTip" style="width:250px"></div>
			</li>
		  </ul>
		  <ul>
