 ...
 * @version $Revision: 1.1 $ ($Author: ljyan_jhtpay $)
 */
public class SmartListHelper {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public SmartListHelper(List list, int fullSize, int itemsInPage,
			TableProperties tableProperties, boolean partialList) {
		if (log.isDebugEnabled()) {
			log.debug(Messages.getString("SmartListHelper.debug.instantiated", //$NON-NLS-1$
					new Object[] { Integer.valueOf(list.size()),
							Integer.valueOf(itemsInPage),
	...
	public String getSearchResultsSummary() {
		...
		if (this.fullListSize == 0) {
			...
			objs = new Object[] { Integer.valueOf(this.fullListSize),
