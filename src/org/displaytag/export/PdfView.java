...
import org.displaytag.utils.DisplayTagUtils;
...
public class PdfView implements BinaryExportView {
	...
	protected void initTable() throws BadElementException {
		...
		smallFont = FontFactory.getFont("STSong-Light", "UniGB-UCS2-H",
				Font.DEFAULTSIZE); //��Ϊ
	}
	...
	protected void generateRows() throws JspException, BadElementException {
		...
		while (rowIterator.hasNext()) {
			...
			while (columnIterator.hasNext()) {
				...
				//��ӵ����HTML��ǩ���˹��ܣ�2010-4-16 by ljyan
				if (null != value) {
					value = DisplayTagUtils.html2Text(value.toString());
				}
